    ...
    <>
      <div className="fixed top-0 right-0 h-full w-64 bg-gray-100 shadow-lg p-4 flex flex-col items-center">
        ...
        <div className="text-center space-y-2">
          <p className="font-bold text-lg">Miguel Maldonado Gutierrez</p>
      ...
      <div>
        ...
        <div className="fixed bottom-0 right-0 mb-4 mr-4 flex space-x-4">
          <a href="github.com/miguelmaldonado" target="_blank" rel="noopener noreferrer">
            <img 
              src="/git.svg" 
              alt="GitHub" 
              className="w-8 h-8"
          ...
          <a href="https://www.linkedin.com/in/miguelmaldonado" target="_blank" rel="noopener noreferrer">
            <img 
              src="/linkedin.svg" 
              alt="LinkedIn" 
              className="w-8 h-8"
